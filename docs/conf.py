#!/usr/bin/env python
#
# remote-compression documentation build configuration file, created by
...
version = remote_compression.__version__
# The full version, including alpha/beta/rc tags.
release = remote_compression.__version__
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/balouf/remote-compression",
...
htmlhelp_basename = 'remote_compressiondoc'
...
latex_documents = [
    (master_doc, 'remote_compression.tex',
     'Remote Compression Documentation',
